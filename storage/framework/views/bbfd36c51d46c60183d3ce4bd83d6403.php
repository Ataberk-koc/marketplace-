...
<?php $__env->startSection('title', 'Ürün Eşleştirme - Trendyol'); ?>
...
<div class="container-fluid" x-data="productMapping()">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('admin.trendyol.index')); ?>" class="btn btn-outline-secondary">
    ...
    <div class="row">
        ...
        <div class="col-lg-5">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.trendyol.save-product-mapping')); ?>" method="POST" @submit="validateForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <select x-model="selectedBrand" 
                                ...
                                <?php $__currentLoopData = $localBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($brand->id); ?>">
                                        <?php echo e($brand->name); ?> (<?php echo e($brand->products_count); ?> ürün)
                                    </option>
                        ...
                        <div class="mb-4" x-show="selectedProduct" x-transition>
                            ...
                            <datalist id="trendyolBrandsList">
                                <?php $__currentLoopData = $trendyolBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="mb-4" x-show="selectedTrendyolBrandName" x-transition>
                            ...
                            <select x-model="selectedTrendyolCategory" 
                                ...
                                <?php $__currentLoopData = $trendyolCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category['id']); ?>" 
                                        data-name="<?php echo e($category['name']); ?>"
                                        data-leaf="<?php echo e(isset($category['subCategories']) && count($category['subCategories']) > 0 ? 'false' : 'true'); ?>">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-3">
                            <h4 class="text-primary mb-0"><?php echo e($stats['total_products']); ?></h4>
                            <small class="text-muted">Toplam</small>
                        </div>
                        <div class="col-3">
                            <h4 class="text-warning mb-0"><?php echo e($stats['mapped_products']); ?></h4>
                            <small class="text-muted">Bekleyen</small>
                        </div>
                        <div class="col-3">
                            <h4 class="text-success mb-0"><?php echo e($stats['sent_products']); ?></h4>
                            <small class="text-muted">Gönderildi</small>
                        </div>
                        <div class="col-3">
                            <h4 class="text-danger mb-0"><?php echo e($stats['unmapped_products']); ?></h4>
        ...
        <div class="col-lg-7">
            ...
            <ul class="nav nav-tabs mb-3" id="productTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pending-tab" data-bs-toggle="tab" data-bs-target="#pending" type="button" role="tab">
                        <i class="bi bi-clock"></i> Bekleyen (<?php echo e($existingMappings->count()); ?>)
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="sent-tab" data-bs-toggle="tab" data-bs-target="#sent" type="button" role="tab">
                        <i class="bi bi-check-circle"></i> Gönderildi (<?php echo e($sentProducts->count()); ?>)
                    </button>
                </li>
            </ul>
                ...
                <div class="tab-pane fade show active" id="pending" role="tabpanel">
                    <div class="card">
                        <div class="card-header bg-warning text-dark d-flex justify-content-between align-items-center">
                            ...
                            <?php if($existingMappings->count() > 0): ?>
                                <form action="<?php echo e(route('admin.trendyol.bulk-send')); ?>" method="POST" style="display: inline;"
                                      onsubmit="return confirm('<?php echo e($existingMappings->count()); ?> ürünü Trendyol\'a göndermek istediğinize emin misiniz?');">
                                    <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body">
                            <?php if($existingMappings->isEmpty()): ?>
                            ...
                            <?php else: ?>
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $existingMappings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapping): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                    <strong><?php echo e($mapping->product->name); ?></strong>
                                                    <br>
                                                    <small class="text-muted">
                                                        <?php echo e($mapping->product->brand->name ?? 'N/A'); ?> - 
                                                        <?php echo e($mapping->product->category->name ?? 'N/A'); ?>

                                                    </small>
                                                </td>
                                                <td><?php echo e($mapping->trendyol_category_name); ?></td>
                                                <td><?php echo e($mapping->trendyol_brand_name); ?></td>
                                                <td>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <div>
                                                        <strong class="text-success"><?php echo e(number_format($salePrice, 2)); ?> ₺</strong>
                                                        <?php if($listPrice != $salePrice): ?>
                                                            <br>
                                                            <small class="text-muted text-decoration-line-through"><?php echo e(number_format($listPrice, 2)); ?> ₺</small>
                                                        <?php endif; ?>
                                                    </div>
                                                    <?php if($mapping->custom_price || $mapping->custom_sale_price): ?>
                                                        <small class="badge bg-info">Özel</small>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <div class="btn-group btn-group-sm">
                                                        <form action="<?php echo e(route('admin.trendyol.send-single-product', $mapping->id)); ?>" method="POST" 
                                                              style="display: inline;"
                                                              onsubmit="return confirm('<?php echo e($mapping->product->name); ?> ürününü Trendyol\'a göndermek istediğinize emin misiniz?');">
                                                            <?php echo csrf_field(); ?>
                                                        ...
                                                        <form action="<?php echo e(route('admin.trendyol.delete-product-mapping', $mapping->id)); ?>" method="POST" 
                                                              style="display: inline;"
                            ...
                            <?php else: ?>
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $sentProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapping): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                    <strong><?php echo e($mapping->product->name); ?></strong>
                                                    <br>
                                                    <small class="text-muted"><?php echo e($mapping->product->sku); ?></small>
                                                </td>
                                                <td>
                                                    <small>
                                                        <strong>Kat:</strong> <?php echo e($mapping->trendyol_category_name); ?><br>
                                                        <strong>Marka:</strong> <?php echo e($mapping->trendyol_brand_name); ?>
                                                ...
                                                <td>
                                                    <?php if($mapping->status === 'sent'): ?>
                                                        <span class="badge bg-primary">Gönderildi</span>
                                                    <?php elseif($mapping->status === 'approved'): ?>
                                                        <span class="badge bg-success">Onaylandı</span>
                                                    <?php elseif($mapping->status === 'rejected'): ?>
                                                        <span class="badge bg-danger">Reddedildi</span>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <small><?php echo e($mapping->sent_at ? $mapping->sent_at->format('d.m.Y H:i') : '-'); ?></small>
                                                </td>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
            ...
            <?php if($stats['unmapped_products'] > 0): ?>
            <div class="alert alert-warning mt-3">
                <i class="bi bi-exclamation-triangle"></i> 
                <strong><?php echo e($stats['unmapped_products']); ?></strong> ürün henüz Trendyol ile eşleştirilmemiş.
            </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\marketplace-entegrasyonu\resources\views/admin/trendyol/product-mapping-alpine.blade.php ENDPATH**/ ?>