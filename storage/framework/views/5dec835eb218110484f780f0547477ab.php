    ...
    function productEditor() {
        return {
            productData: {
                ...
                model_code: '<?php echo e(old('model_code', $product->model_code)); ?>',
                description: '<?php echo e(old('description', $product->description)); ?>',
                sku: '<?php echo e(old('sku', $product->sku)); ?>',
                price: '<?php echo e(old('price', $product->price)); ?>',
                discount_price: '<?php echo e(old('discount_price', $product->discount_price)); ?>',
                stock_quantity: '<?php echo e(old('stock_quantity', $product->stock_quantity)); ?>',
                vat_rate: <?php echo e(old('vat_rate', $product->vat_rate ?? 20)); ?>,
                dimensional_weight: <?php echo e(old('dimensional_weight', $product->dimensional_weight ?? 1.0)); ?>,
                cargo_company_id: <?php echo e(old('cargo_company_id', $product->cargo_company_id ?? 'null')); ?>,
                category_id: '<?php echo e(old('category_id', $product->category_id)); ?>',
                brand_id: '<?php echo e(old('brand_id', $product->brand_id)); ?>',
                is_active: <?php echo e(old('is_active', $product->is_active) ? 'true' : 'false'); ?>,
            ...
            initializeProduct() {
                ...
                <?php if($product->variants && $product->variants->count() > 0): ?>
                    ...
                    ?>
                    this.variants = <?php echo json_encode($variantsData, 15, 512) ?>;
                <?php endif; ?>

                // Load existing attributes
                <?php if($product->productAttributes && $product->productAttributes->count() > 0): ?>
                    <?php
                    ...
                    ?>
                    this.attributes = <?php echo json_encode($attributesData, 15, 512) ?>;
                <?php endif; ?>
            },
            addVariant() {
                this.variants.push({
...
<script>
let imageCount = <?php echo e(count($product->images ?? [])); ?>;
